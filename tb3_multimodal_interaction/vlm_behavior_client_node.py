...
class VlmBehaviorClient(Node):
    def __init__(self):
        ...
        self.declare_parameter("llama_base_url", "")
        ...
        if not self.llama_base_url or not self.model:
            raise ValueError("llama_base_url and model must be supplied by the host manifest launch path")
